# AWSDotNetWebAdvert.SearchWorker
...
Execute unit tests
```
    cd "AWSDotNetWebAdvert.SearchWorker/test/AWSDotNetWebAdvert.SearchWorker.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AWSDotNetWebAdvert.SearchWorker/src/AWSDotNetWebAdvert.SearchWorker"
